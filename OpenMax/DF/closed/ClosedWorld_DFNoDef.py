...
# with open("models/DF_onAWF_data_model5.json", "w") as json_file:
# 	json_file.write(model_json)
# # serialize weights to HDF5
# model.save_weights("models/DF_onAWF_data_model5.h5")
# print("Saved model DF_onAWF_data_model5 to disk")

model.save('DF_closed_keras.h5')
