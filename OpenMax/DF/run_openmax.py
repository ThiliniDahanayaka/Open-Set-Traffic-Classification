...
# model = build(10, "/home/sec-user/thilini/open-set_LCN/MNIST/models/MNIST.hdf5")
...
model = load_model("/media/SATA_1/thilini_open_extra/final_codes/OpenMax/DF/closed/DF_closed_keras.h5")
