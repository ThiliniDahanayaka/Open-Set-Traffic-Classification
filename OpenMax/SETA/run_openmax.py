...
model = load_model("/media/SATA_1/thilini_open_extra/final_codes/OpenMax/SETA/closed/models/seta_closed_trial_"+trial+".hdf5")
# score = model.evaluate(dataXr, np_utils.to_categorical(y_train, n_closed))
# print(score[1])
pred = model.predict(dataXr)


model_path =  "/media/SATA_1/thilini_open_extra/final_codes/OpenMax/SETA/closed/models/seta_closed_trial_"+trial+".hdf5"
