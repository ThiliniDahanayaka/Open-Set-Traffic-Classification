...
model=load_model('IoT_without_softmax_s5.hdf5')
...
dataset_dir = "/home/Yasod/IOT/dataset/"
...
with open('/home/Yasod/Yasod/IOT/Openmax_trained', 'wb') as file_pi:
...
with open('/home/Yasod/Yasod/IOT/Openmax_trained', 'rb') as f:
    openmax_ob = pickle.load(f)

X_open=np.load('./Temp//home/Yasod/Yasod/IOT/dataset/X_open.npy')
X_open=X_open[:,:1500]
