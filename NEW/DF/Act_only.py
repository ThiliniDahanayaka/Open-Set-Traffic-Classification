...
model_path = "/media/SATA_1/thilini_open_extra/final_codes/OpenMax/DF/closed/DF_closed_keras.h5"
datapath = "/media/SATA_1/thilini_open_extra/final_datasets/DF/"
...
# # np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/pred_train', pred)
...
# 	out, _ = m.predict(X)
# 	print(i, out.shape)	
# 	np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/'+names[i], out)

# m = build(n_closed, model_path, len(names)-1)
# out = m.predict(X)
# print(len(names)-1, out.shape)	
# np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/'+names[len(names)-1], out)
...
# 	out, _ = m.predict(X)
# 	print(out.shape)
# 	np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/open_'+names[i], out)

# m = build(n_closed, model_path, len(names)-1)
# out = m.predict(X)
# print(out.shape)
# np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/open_'+names[len(names)-1], out)
...
# 	out, _ = m.predict(X)
# 	print(out.shape)
# 	np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/valid_'+names[i], out)

# m = build(n_closed, model_path, len(names)-1)
# out = m.predict(X)
# print(out.shape)
# np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/valid_'+names[len(names)-1], out)
...
# 	out, _ = m.predict(X)
# 	print(out.shape)
# 	np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/test_'+names[i], out)

# m = build(n_closed, model_path,  len(names)-1)
# out = m.predict(X)
# print(out.shape)
# np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/test_'+names[ len(names)-1], out)
...
# 	np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/act_only/MAVS/_MAVs_'+str(n_max)+str(c), logits)
...
# np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/pred_valid', pred)
...
# 		a=np.array(mav)
# 		# b = mavs[int(y[i])]
# 		b = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/act_only/MAVS/_MAVs_'+str(n_max)+str(c)+'.npy', allow_pickle=True)
# 		diff = a-b
...
# np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/act_only/threshs_list_'+str(n_max), threshs)
...
model_f = load_model(model_path)
pred = model_f.predict(X[:, :, np.newaxis])
np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/pred_test', pred)
pred = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/pred_test.npy')
pred = np.argmax(pred, axis=1)
res = []

threshs = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/act_only/threshs_list_'+str(n_max)+'.npy')
m_prenult = build(n_closed, model_path, 11)
probs = []
...
for c in range(0, 1):
	...
	for i in range(0, X.shape[0]):
		...
		a = mav
		# b = mavs[int(y[i])]
		b = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/act_only/MAVS/_MAVs_'+str(n_max)+str(int(pred[i]))+'.npy')
		diff = a - b
		diff = np.linalg.norm(diff)
		# diff = np.dot(a, b)/( np.linalg.norm(a)* np.linalg.norm(b))
...
model_f = load_model(model_path)
pred = model_f.predict(X[:, :, np.newaxis])
np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/pred_open', pred)
pred = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/pred_open.npy')
pred = np.argmax(pred, axis=1)
probs = []
