...
from utility import LoadDataNoDefCW as LoadDataIot
...
_, _, X_valid, y_valid, X_test, y_test, X_open, y_open = LoadDataIot('IOT', NB_CLASSES, trial_num=trial)



filepath = '/media/SATA_1/thilini_open_extra/final_codes/OpenMax/IOT/closed/models/iot_closed_trial_'+trial+'.hdf5'
