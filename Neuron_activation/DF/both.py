...
# 	outs.append(np.absolute(np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/'+names[i]+'.npy')))
...
# np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/both/max_positions_'+str(n_max), res)
...
# # # ------------------------------------------get MAVs
# max_positions = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/both/max_positions_'+str(n_max)+'.npy')
# print('Getting MAVs')
# X, y, _, _, _, _ = LoadDataNoDefCW()
...
# outs= []
# for i in range(0, len(names)):
# 	outs.append(np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/'+names[i]+'.npy'))
# 	print(outs[i].shape)
...
# 	np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/both/MAVS/'+str(n_max)+str(c), logits)
...
# outs= []
# for i in range(0, len(names)):
# 	outs.append(np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/valid_'+names[i]+'.npy'))
...
# 		a=np.array(mav)
# 		# b = mavs[int(y[i])]
# 		b = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/both/MAVS/'+str(n_max)+str(c)+'.npy', allow_pickle=True)
# 		diff = a-b
...
# np.save('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/both/threshs_list_'+str(n_max), threshs)
...
for i in range(0, len(names)):
	# print(i)
	a = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/test_'+names[i]+'.npy')
	print(a.shape)
	outs.append(a)
...
threshs = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/both/threshs_list_'+str(n_max)+'.npy')
max_positions =  np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/both/max_positions_'+str(n_max)+'.npy')
...
for c in range(0, 1):
	...
	for i in range(0, X.shape[0]):
		...
		for j in range(0,max_positions.shape[0]):
			...
			mav = np.append(mav, out)
		a=np.array(mav)
		b = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/both/MAVS/'+str(n_max)+str(int(pred[i]))+'.npy')
		diff = a - b
		diff = np.linalg.norm(diff)
		# diff = np.dot(a, b)/( np.linalg.norm(a)* np.linalg.norm(b))
...
for i in range(0, len(names)):
	# print(i)
	a = np.load('/media/SATA_1/thilini_open_extra/final_codes/New/DF/temp/open_'+names[i]+'.npy')[0:l]
	print(a.shape)
	outs.append(a)
print('predicted')
