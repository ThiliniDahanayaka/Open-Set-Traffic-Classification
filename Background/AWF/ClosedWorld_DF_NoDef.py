...
NB_CLASSES = 201 # number of outputs = number of classes
...
# model_saver = ModelCheckpoint('AWF_back.h5py',
...
model=load_model("/media/SATA_1/thilini_open_extra/final_codes/Background/AWF/AWF_back.h5py")
